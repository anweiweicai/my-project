  ...
  <div style="display: flex; max-width: 950px; margin: auto">
    <div class="setting-left">
        ...
        <el-form :model="baseForm" :rules="rule" ref="baseFormRef" label-position="top"
          ...
          <el-form-item label="性别">
            <el-radio-group v-model="baseForm.gender">
              <el-radio :label="0">男</el-radio> <!--  加了冒号就变为整型而非字符串 -->
          ...
          <el-form-item label="个人简介" prop="desc">
            <el-input v-model="baseForm.desc" maxlength="230" type="textarea" :rows="6"/>
          </el-form-item>
          <div>
      ...
      <card style="margin-top: 10px" :icon="Message"  title="电子邮件设置" desc="您可以在这里修改默认绑定的电子邮件地址">
        <el-form :model="emailForm" :rules="rule" ref="emailFormRef" @validate="onValidate" label-position="top" style="margin: 0 10px 10px 10px">
          <el-form-item label="电子邮件" prop="email">
            <el-input v-model="emailForm.email"/>
          </el-form-item>
          <el-form-item prop="code">
            <el-row style="width: 100%" :gutter="10" prop="code">
              <el-col :span="18">
